...
public:
	...
	bool start() {
		return !(pthread_create(&this->m_thread,NULL,this->entry_func,
				this));
	}
...
protected:
	...
	uint m_thread_id; // A number from 0 -> Number of threads initialized,
	// providing a simple numbering for you to use
